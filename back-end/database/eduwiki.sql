...
CREATE TABLE course_class (
  ...
  course_class_version INTEGER,
  course_id INTEGER REFERENCES course,
  class_id INTEGER,
  term_id INTEGER,
  FOREIGN KEY (class_id, term_id) REFERENCES class(class_id, term),
  PRIMARY KEY (course_class_id, course_id, class_id, term_id)
);
...
CREATE TABLE class_misc_unit (
  ...
  FOREIGN KEY (course_id, class_id, term_id, course_class_id) REFERENCES course_class(course_id, class_id, term_id, course_class_id),
  PRIMARY KEY (id)
);
