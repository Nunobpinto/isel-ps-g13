...
insert into work_assignment (work_assignment_id, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (1,'ze', '1', gen_random_uuid(),gen_random_uuid(),current_date,false ,true ,true ,false ,current_timestamp);

insert into work_assignment_version (work_assignment_id, work_assignment_version, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (1, 1, 'ze', '1', gen_random_uuid(),gen_random_uuid(),current_date,false ,true ,true ,false ,current_timestamp);

insert into course_misc_unit (misc_type, course_id, term_id)
    values ('WORK_ASSIGNMENT', 1, 2);

insert into work_assignment (work_assignment_id, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (2,'ze', '2', gen_random_uuid(), gen_random_uuid(), current_date,false ,true ,true ,false ,current_timestamp);

insert into work_assignment_version (work_assignment_id, work_assignment_version, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (2, 1, 'ze', '2', gen_random_uuid(),gen_random_uuid(),current_date,false ,true ,true ,false ,current_timestamp);

insert into course_misc_unit (misc_type, course_id, term_id)
    values ('WORK_ASSIGNMENT', 3, 2);

insert into work_assignment (work_assignment_id, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (3,'ze', '3', gen_random_uuid(),gen_random_uuid(),current_date,false ,true ,true ,false ,current_timestamp);

insert into work_assignment_version (work_assignment_id, work_assignment_version, created_by, phase, sheet_id, supplement_id, due_date, individual, late_delivery, multiple_deliveries, requires_report, time_stamp)
    values (3, 1, 'ze', '3', gen_random_uuid(),gen_random_uuid(),current_date,false ,true ,true ,false ,current_timestamp);
