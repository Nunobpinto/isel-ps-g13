...
insert into isel.exam_version (exam_id, exam_version, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (4, 1, 'ze', gen_random_uuid(), '2012-07-14','EXAM', '1ª','A.2.14',current_timestamp);

insert into isel.exam_version (exam_id, exam_version, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (4, 2, 'jg', gen_random_uuid(), '2012-07-14','TEST', '2ª','A.2.11',current_timestamp);

insert into isel.course_misc_unit (misc_type, course_id, term_id)
    values ('EXAM_TEST', 1, 1);

insert into isel.exam (exam_id, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (5, 'ze', null ,current_date,'EXAM', '2ª','G.0.14',current_timestamp);

insert into isel.exam_version (exam_id, exam_version, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (5, 1, 'ze', null ,current_date,'EXAM', '2ª','G.0.14',current_timestamp);

insert into isel.course_misc_unit (misc_type, course_id, term_id)
    values ('EXAM_TEST', 2, 1);

insert into isel.exam (exam_id, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (6, 'ze', gen_random_uuid() ,current_date,'TEST', '1ª','A.2.14',current_timestamp);

insert into isel.exam_version (exam_id, exam_version, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (6, 1, 'ze', gen_random_uuid(),current_date,'TEST', '1ª','A.2.14',current_timestamp);

insert into isel.course_misc_unit (misc_type, course_id, term_id)
    values ('EXAM_TEST', 2, 2);

insert into isel.exam (exam_id, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (7, 'ze', gen_random_uuid() ,current_date,'EXAM', '2ª','A.2.14',current_timestamp);

insert into isel.exam_version (exam_id, exam_version, created_by, sheet_id, due_date, exam_type, phase, location, time_stamp)
    values (7, 1, 'ze', gen_random_uuid(),current_date,'EXAM', '2ª','A.2.14',current_timestamp);
...
insert into isel.exam_report (exam_id, sheet_id, due_date, exam_type, phase, location, reported_by, votes, time_stamp)
    values (4, gen_random_uuid(), '2015-07-11', 'TEST', '1ª', 'E.2.20', 'sara', 14, current_timestamp);

insert into isel.exam_report (exam_id, sheet_id, due_date, exam_type, phase, location, reported_by, votes, time_stamp)
    values (4, gen_random_uuid(), '2015-07-09', 'TEST', '1ª', 'E.2.20', 'rita', 81, current_timestamp);
