...
class AuthorizationConfig {
    ...
    companion object {
        ...
        val ROLE_HIERARCHY = "$ROLE_DEV > $ROLE_ADMIN $ROLE_ADMIN > $ROLE_BEGINNER"
        ...
        val REPUTATION_MATCHERS = mapOf(
                ...
                (POST   to "/classes/{classId}/courses/{courseId}/stage") to ROLE_BEGINNER,
                ...
                // Programme Course
                (GET    to "/programmes/{programmeId}/courses") to ROLE_BEGINNER,
                (POST    to "/programmes/{programmeId}/courses") to ROLE_ADMIN,
                ...
                (POST   to "/programmes/{programmeId}/courses/stage") to ROLE_BEGINNER,
                (GET    to "/programmes/{programmeId}/courses/stage/{stageId}") to ROLE_BEGINNER,
                (POST   to "/programmes/{programmeId}/courses/stage/{stageId}") to ROLE_ADMIN,
