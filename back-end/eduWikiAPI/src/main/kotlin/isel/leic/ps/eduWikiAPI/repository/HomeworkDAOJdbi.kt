...
interface HomeworkDAOJdbi : HomeworkDAO {
    ...
    @SqlUpdate(
            "INSERT INTO $HOMEWORK_TABLE ( " +
                    ...
                    ":homework.sheet, :homework.dueDate, :homework.lateDelivery, " +
    ...
    @SqlQuery(
            "INSERT INTO $HOMEWORK_STAGE_TABLE ( " +
                    ...
                    "$HOMEWORK_CREATED_BY " +
                    ") " +
                    "VALUES(:stagedClassMiscUnitId, :homeworkStage.sheet, :homeworkStage.dueDate, " +
    ...
    @SqlUpdate(
            "INSERT INTO $HOMEWORK_VERSION_TABLE ( " +
                    ...
                    ":homeworkVersion.sheet, :homeworkVersion.dueDate, :homeworkVersion.lateDelivery, " +
    ...
    @SqlUpdate(
            "INSERT INTO $HOMEWORK_REPORT_TABLE ( " +
                    ...
                    "$HOMEWORK_TIMESTAMP " +
                    ") " +
                    "VALUES (:homeworkReport.homeworkId, :homeworkReport.sheet, :homeworkReport.dueDate, " +
